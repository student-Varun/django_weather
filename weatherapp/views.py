...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=6c84134eaac8036ee0e9ead66380419f'
    PARAMS = {'units':'metric'}
    ...
    start = (page - 1) * 10 + 1
    searchType = 'image'
    city_url = f"https://www.googleapis.com/customsearch/v1?key=AIzaSyCdAK3SmrKSdYco-0bhJ0pJ0wIR2jijK3E&cx=63d01bb2cb58d4eac&q={query}&start={start}&searchType={searchType}&imgSize=xlarge"
